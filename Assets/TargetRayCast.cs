...
public class TargetRayCast : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Debug.DrawRay(transform.position, transform.forward * hit.distance, _color);
            Debug.DrawLine(transform.position + transform.forward * hit.distance - transform.lossyScale / 2f,
                           transform.position + transform.forward * hit.distance + transform.lossyScale / 2f, _color);
        ...
        {
            Debug.DrawRay(transform.position, transform.forward * _maxDistance, _color);
        }
    }
